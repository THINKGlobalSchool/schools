...
$form_body  = "<p><label>" . elgg_echo('schools:label:schoolregcode') . "<br />" . elgg_view('input/text' , array('internalname' => 'school_registration_code', 'class' => "input_text name", 'value' => $name)) . "</label></p>";
...
echo elgg_view('input/form', array(
	'action' => elgg_get_site_url() . "action/schools/register",
	'body' => $form_body,
	'class' => "margin_top"
));
?>
