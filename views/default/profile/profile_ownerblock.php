...
$school_info = get_user_school_info($user);
...
if ($section == 'details') {
	...
	$more_info .= "<p class='profile_info briefdescription'>{$school_info}</p>";
...
// provide a view to extend for profile pages ownerblock tool-links
$extend = elgg_view('profile_ownerblock/extend');
